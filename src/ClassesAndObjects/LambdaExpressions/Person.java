...
public class Person {
    ...
    public static List<Person> createRoster() {
        ...
        roster.add(new Person("Fred", IsoChronology.INSTANCE.date(1980, 6, 20),
                Sex.MALE, "fred@example.com"));
        roster.add(new Person("Jane", IsoChronology.INSTANCE.date(1990, 7, 15),
                Sex.FEMALE, "jane@example.com"));
        roster.add(new Person("George", IsoChronology.INSTANCE.date(1996, 4, 3 ),
                Sex.MALE, "george@example.com"));
        roster.add(new Person("Ade", IsoChronology.INSTANCE.date(2000, 12, 7),
                Sex.FEMALE, "ade@example.com"));
