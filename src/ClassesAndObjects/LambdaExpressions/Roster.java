...
public class Roster {
    ...
    //  Approach 6: Use Standard Functional Interfaces with Lambda Expression
    ...
    public static void main(String... args) {
        ...
        System.out.println("Persons between the ages 14 and 30: ");
        printPersonsWithinAgeRange(roster, 14, 30);
        System.out.println();

        //  Approach 3: Specify Search Criteria Code in a Local Class

        System.out.println("Persons who are eligible for Selective Services: ");

        class CheckPersonEligibleForSelectiveServices implements CheckPerson {
        ...
        printPersons(roster, new CheckPersonEligibleForSelectiveServices());
